...
api.applyCommands = function(argv) {
  ...
  internal.runCommands(argv, opts, function(err) {
    ...
    if (opts.legacy)
      return callback(null, internal.toLegacyOutputFormat(outputArr))
...
api.runCommandsXL = function(argv) {
  ...
  var child = require('child_process').exec(command, {}, function(
    err,
    stdout,
    stderr
  ) {
...
internal.convertLegacyCommands = function(arr, inputObj) {
  var i = utils.find(arr, function(cmd) {
    return cmd.name == 'i'
  })
  var o = utils.find(arr, function(cmd) {
    return cmd.name == 'o'
  })
  if (!i) {
    i = { name: 'i', options: {} }
